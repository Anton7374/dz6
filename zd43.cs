void UserDialogs(int diaologCode, params double[] paramsArray)
{
    ...
    { 
         case 0:
            userDialog = "Введите значение для к1: ";
            break;
         case 1:
            userDialog = "Введите значение для b1: ";
            break;
         case 2:
            userDialog = "Введите значение для к2: ";
            break;
         case 3:
            userDialog = "Введите значение для b2: ";
            break;
         case 4:
            userDialog = $"По указанным Вами параметрам: к1 = {paramsArray[0]} b1 = {paramsArray [1]} и k2 = {paramsArray[2]} b2 = {paramsArray[3]}\n"
            + "ответ будет: Прямые совпадают друг с другом.";
            break;
         case 5:
            userDialog = $"По указанным Вами параметрам: к1 = {paramsArray[0]} b1 = {paramsArray [1]} и к2 = {paramsArray[2]} b2 = {paramsArray[3]}\n"
